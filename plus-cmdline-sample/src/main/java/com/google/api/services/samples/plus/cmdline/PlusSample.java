...
public class PlusSample {
  ...
  /** OAuth 2.0 scopes. */
  private static final List<String> SCOPES = Arrays.asList(PlusScopes.PLUS_LOGIN,
  ...
  public static void main(String[] args) {
    try {
      ...
      plus =
          new Plus.Builder(httpTransport, JSON_FACTORY, credential).setApplicationName(
  ...
  private static void getActivity() throws IOException {
    ...
    activityId = "z12zwhoqktywcxf2v22hjfdbflfod5zdl";
  ...
  /** Get the profile for the authenticated user. */
  private static void getFriendsList() throws IOException {
    ...
    while (people != null) {
      for (Person person : people) {
        System.out.println(String.format("%s,%s", person.getDisplayName(), person));
      }
